...
if(test.randomTF == T){
  ...
  XRD.rTF.ACADB.comb <- Plot.randomTF(MPsurf = M.br.GDGT.karid, MPpaleo = GDGT.XRD.conv,  Mclim = MC.karid, Database = "ACADB-combined", Lake = "XRD", 
                                      Save.path = "Resultats/China/GDGT/Cores/XRD/Func_trans/XRD_randomFT_ACADB_comb.Rds", return.plot = T, 
                                      H = 500, W = 2000, Save.plot = "Figures/China/GDGT/Cores/XRD/randomTF/XRD_randomTF_ACADB_comb.pdf")}
